...
public class SensorsListActivity extends BaseActivity {
	  ...
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.sensors_list_fragment);
	    ...
	    beaconManager.connect(new BeaconManager.ServiceReadyCallback() {
	      ...
	      public void onServiceReady() {
	        try {
	          ...
	          Toast.makeText(SensorsListActivity.this, "Cannot start ranging, something terrible happened",
	      ...
	      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
	        if (getIntent().getStringExtra(EXTRAS_TARGET_ACTIVITY) != null) {
	          try {
	            ...
	            Intent intent = new Intent(SensorsListActivity.this, clazz);
